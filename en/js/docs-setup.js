NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$interpolate $log $q $rootscope $scope $translate $translateprovider $translaterefreshend $translaterefreshstart $translationtable actual additional aliases allownamespaces angular-translate api app application array async asynchronous asynchronously background based broadcast browser call calls care case change choosed class client cloakclassname compiling config configured contents copy core current currently data default defined delimiter dictionary directive downloading drop dropdown dynamic effort en_us enabled error events existent expects fallback fallbacklanguage false falsy file finished fn force forceasyncreload function getavailablelanguagekeys gettranslationtable handling hash hasn headline_text hello ids instant instantly internal interpolate interpolation invoke invoked isforceasyncreloadenabled iskeepcontent isn ispostcompilingenabled isready iteration keepcontent key langkey language languages library list load loaded loadercache loaders loading mapping method methods_isready methods_onready module namespaces negotiatelocale nested nestedobjectdelimeter note null object onready optional optionally param parameters params pascalprecht phase pointed post preferred preferredlanguage process processed progress promise proposedlanguage provide provided ready recommended refresh refreshed refreshes refreshing registered reject reload remember represents resolveclientlocale resolved resolver result return returned returns rules runtime sanitize selection service set sets setting simply skipped stack start storage storagekey store storing strategy string table tables tag takes target tells text throw token translate translate-cloak translatedtext translation translationid undefined uniform usefallbacklanguage useinterpolation values version versioninfo written",
      "isDeprecated": false
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$identifier $interpolate $translatedefaultinterpolation $translatesanitization agains angular angularjs angulars api aware configure context current currently default directive function getinterpolationidentifier identifier input interpolate interpolated interpolates interpolation interpolator key language locale object params pascalprecht proper returns sanitization sanitize service services set setlocale sets strategy string strings translate translation translationid values",
      "isDeprecated": false
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$translatepartialloaderprovider add addpart angular-translate api application asks avoids chainable check checks configuration configure data delete deletepart directly function future ispartavailable lang language lifetime list load loaded loader loading method needed non-empty note object param params parts pascalprecht pass pattern phase priority provider registers removes returning returns runtime server set setpart sets specific startup string table target throw translate translation type url urltemplate wrong",
      "isDeprecated": false
    },
    {
      "section": "api",
      ...
      "keywords": "$cachefactory $compile $http $injector $translate $translatecookiestorage $translatelocalstorage $translateprovider $translatestaticfilesloader $translateurlloader $translationcache $translationtable actual add adding addinterpolation adds alias aliases allownamespaces allows angular-translate angularjs api app application-wide argument arguments array async asynchronous automatically based bcp bcp47 behavior best boolean browser browsers build built-in cache cache-object call called calling change choosed class client cloakclassname combination compiling config configuration configure configured considering continue convention converted correct current currently custom customhandler de_de default define defined defines delimiter dep1 dep2 depending determine determinepreferredlanguage determining developers directive directivepriority directly disable disabled disabling doesn don en en-us en_us enabled enrich entries error example exist expects explicit extended extension factory fallbacklanguage false files filter filters find fitting fn force forceasyncreload format function functionality gender getlocale greeting hallo handler hello high http hyphens ietf implement improve indicator indicators initial innerhtml inside instantiated intercept interface internal internally interpolation invoking isn java javascript job js keepcontent key langkey language languagekeys languages layer left level ll loaded loader loaderfactory loaders locale log manage map meaning messageformat method methods methods_determinepreferredlanguage methods_uniformlanguagetag missing missingtranslationhandler modify module multiple namespace namespaced namespaces namespacesenabled nested nestedobjectdelimeter normal not_found object optional options org parameter pascalprecht pass passing performance plain pluralization post postprocess preferred preferredlanguage prefix priority process processed processor provided recommended register registeravailablelanguagekeys registered registering registers reload represent represents resolveclientlocale resolved resolver result return returns risk sanitation scope second selection separator service services set sets setting shortcut simply specific sr-latn sr-latn-rs standard startup stateful statefulfilter stateless storage storagekey storageprefix strategy string style supports table tables tag tells throw translate translate-cloak translate-directive translated translation translation-tables translationid translationnotfoundindicator translationnotfoundindicatorleft translationnotfoundindicatorright translations translationtable treat true type undefined underscores uniform uniformlanguagetag uppercase url usage usecookiestorage useinterpolation useloader useloadercache uselocalstorage usemessageformatinterpolation usemissingtranslationhandler usemissingtranslationhandlerlog usepostcompiling user usesanitizestrategy usestaticfilesloader usestorage useurlloader valid values w3 welt whitespace wikipedia work world",
      "isDeprecated": false
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$compile $digest $rootscope $scope $translateprovider angular api attr attributes config controller defines directive dynamic element en expect function hello html ids inject internally js literal locally mapping module ng-class ng-controller ngview object optional pascalprecht pass passed placeholder preferredlanguage sanitize scenario script service strategy string title tobe translate translate-attr translate-attr-attr translate-sanitize-strategy translate-values translatectrl translates translation translation_id translationid translations values with_values",
      "isDeprecated": false
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "ahead angular-translate bower broken build building cdnjs clone cloned code command commands components configured consider course created dependencies developing development dist document download downloading easily embed execute featured files folder framework full generate git github green grunt gruntfile guide happened history html including install installation installing io js latest local love machine matter min navigate needed node_modules npm overview package passed pretty production project properly provided pull purpose raw ready releases repository request rock running send simply source start tasks test testing testrunner tests testsuite things tools unicorn unit version waits watch work",
      "isDeprecated": false
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "keywords": "$emit $on $rootscope $scope $translate $translatechangesuccess $translateprovider accessed achieve add additional angular angular-translate angularjs anotherone app application approach apps asynchronous asynchronously await aware awared awesome basic behaves best bind binding building call callback calling case cases change changed changing code compared config content contents controller controllers convenience correct ctrl data deal default dependency determine deterministic difference directive directly disadvantages display documents doesn don easy en error example exist exists expose extend fail failed features filter fired function future general going guarantee guide hard headline html ideally ids imagine info inject injection inside installed instant intercept interface json language languages level library ll loader loading logic love manipulate mind module multiple myapp namespace namespaced namespaced_paragraph needed ng-app ng-controller non-asynchronous overview paragraph pascalprecht pass performance post preferred preferredlanguage processing promise promises properties provide provided pure re-execute reasons registered rejected request requesting required resolved response result return returns running runtime sample service services similiar simply specific srsly started string successful synchronous table tag things time title translate translated translating translation translationid translationids translations turned two-way unicorn updated usage var variant version versioninfo wait waits ways wonder working works world wouldn wrapped wrapping",
      "isDeprecated": false
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "keywords": "$scope $translate $translateprovider add adding als anf angular angular-translate app applied apps argument asynchronous attribut attribute automatically aware awesome bad basic bcp-47 bcp47 beginners belongs bin browser browserlanguage button button_lang_de button_lang_en buttons calling calls cases change changelanguage code combination components config configuration controller controllers controls cool corresponding course covered ctrl current custom de decide default define detail determine determinepreferredlanguage determines determining deutsch directive doesn dynamic ein en enable englisch english ernsthaft expect expects extend fallback fallbacklanguage feeling find fit function functionality german going good greeting gro guide ha hallo happen hasn headline hello helping hey html ich ids implement interesting internally interpolated interpolation interpoliert introduced invokes key language languages learn learned learning level limit ll loaded loaders loading logic love method missing missing_translation modul module multi myapp navigator needed ng-click ng-controller object oder oops order overview paragraph pascalprecht pass passed passed_as_attribute passed_as_interpolation passed_as_text passing points practice prefer preferred preferredlangkey preferredlanguage pretty properties provide ready recognize registered registers registration replacement resolved return returns risk runtime sample scope searches second service setting setup simple srsly started storage support switch switching systemlanguage table tables tag teaching tells text things time transformed translate translate-values translated translation translations translationsde translationsen turns unicorn uniformlanguagetag update usage userlanguage values var variable_replacement ve version voil welt window work world wurde",
      "isDeprecated": false
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "keywords": "$http $log $on $q $rootscope $scope $translate $translatepartialloader $translatepartialloaderprovider $translatepartialloaderstructurechanged $translateprovider _json_ ability accessing accross achieve activities add adding addition additional addpart adds advanced ago allright alright als alternatively amount anf angular angular-translate angular-translate-loader-partial angular-translate-loader-static-files angular-translate-loader-url angularjs app application applied apps argument array asynchronous asynchronously attribut attribute automate automatically avoid awesome basically beautifully beginners behavior best better big bigger bin bind binding bit blocking bootstraps bower break browser bug build button_lang_de button_lang_en cache caching call called care case change changelanguage changes changing chapter charm checks chosen clever code combination comment common complete complex concatenate config configuration configure configures contact contactctrl content contents control controller controllers cool copy corresponding course covered create ctrl current currently custom customloader data de deal dealing declared dedicated default demand depends describes details deutsch devtools differently disable distinct docs document doesn don double drawback drops effectively ein embedded embeded en enable endpoint englisch english ernsthaft error errors event everytime example execute executed executing existing expects extension extensions factory false fetched file files fired fires fixed flash flickering foo foobar force forceasyncreload forward fouc function functionality german github global gro grunt guide gulp ha handle handler hard haven headline hello hello_text hey html ich imagine inital inject install installable installed instance instances instantiated interesting internally interpolated interpoliert invoke invoked io isn js json key kind lang langkey language languages launches lazy learn learned listening ll load loaded loader loaders loadfailurehandler loading loads locale locale- locale-de locale-en localization locations logical looked love main mainapp manipulate match merged method modul module modules multiple myapp myerrorhandler named needed network ng-click ng-controller ngcookies ngroute nice notice notices npmjs oder onready open options order org overridden overview package paragraph parameter partial partialloader parts pascalprecht passed passed_as_attribute passed_as_interpolation passed_as_text pattern plain post posted preferredlanguage prefix pretty process promise property provide provided provider published pull question quotes real refresh refreshing registered reject rejects reloading reloads rendering request requests required resolve respond response return returns router runtime sample send separate server service services settinga setup short shortcut signature simple simpler simplest simply sits situations solution sources specifc specific specifies srsly standard startup static staticfilesloader straight string structured stuff submodule submodules suffix supply support supports table tables telling text things three time transform translate translate-values translateready translating translation translations ui unicorn untranslated update url urlloader urltemplate useloader useloadercache user usestaticfilesloader useurlloader var variable_replacement ve wanna wasn won work working works world wurde yea yourspecialcacheservice",
      "isDeprecated": false
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "keywords": "$interpolate $locale $scope $translate $translateprovider $translatesanitization add addinterpolation addition alright angular angular-translate app appends basic benutze bin build building button_lang_de button_lang_en calling changelanguage chapters config context controller cool ctrl current currently custom custominterpolation de default deutsch eine en englisch english es exactly expects explicitly factory familiar fand fanden features female follow friend function german getinterpolationidentifier guide gut headline ich identifier implement implementing implements integrate interface interpolate interpolateparams interpolates interpolation interpolations interpolators language learned library loaders locale logic loose love male mapped messageformat method methods module myapp ng-click ng-controller object optional override overridinginterpolationtemporarily overview params pascalprecht plug plural preferredlanguage prepends pretty previous provided purpose read remember return returns runtime sanitation sanitazion sanitize sanitizestrategy select service services set setlocale sets simply smaller smart specific start storages store strategy string strings structure text things translate translate-values translatesanitization translationid translations type unicorn useinterpolation useloader usesanitizevaluestrategy usestorage utilizes val var ve work",
      "isDeprecated": false
    },
    {
      "section": "guide",
    ...
    },
    {
      ...
      "keywords": "$sanitize $sce $scope $translateprovider additionally alias angular angular-translate angularjs app attacks backwards built-in characters chosen color compatibility compatible completely config content controller correctly ctrl default defaults defines demonstrations disabled displayed double en enable encode enforce ensures escape escaped escapeparameters escapes escaping explicitly function future general global guide headline hello href html https interpolation javascript long love method mode module moment myapp_escape_params myapp_escaped myapp_not_escaped myapp_sanitize myapp_sce myapp_sce_params ng-controller ngsanitize null org output overview owasp paragraph parameters pascalprecht php preferredlanguage recommend recommendation regular removed resolved result sanitize sanitized sanitizeparameters sanitizes sce sceparameters secure security serious speaking special standard strategies strategy style text translate translate-values translation translations trustashtml unicorn unsecure usesanitizevaluestrategy utf-8 valid values var variable variant version vulnerable warning wrap wraps xss",
      "isDeprecated": false
    },
    {
      "section": "guide",
