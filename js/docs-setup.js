NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$compile $scope $translateprovider add addition angular angular-translate app attribute attribute_name attributes awesome beginners behavior benefits best better case choose compiling concrete config contents context controller cool couldn covered create ctrl current dataset directive disable dynamically element en enable enabled example expected expressions false feature filter filters flexible function general globally great guide ha handle headline hey html identifier ids interpolate interpolated isn iterator layer logo looping love mentioned module myapp mylogo ng-controller offers overview paragraph pascalprecht pass passed passed_as_attribute passed_as_interpolation passed_as_text png post preferredlanguage processed represents scope sets src srsly starting substitute table text texts ton translate translate-attr-alt translate-attr-attribute_name translate-compile translation translation_id translations turned unicorn unnecessary update updated usage usepostcompiling var version view watch watches ways work works wouldn yeah"
    },
    {
      "section": "guide",
