NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$on $rootscope $scope $translate $translateprovider add angular-translate anonymous application argument async based better broadcasting call careful changes code consistency decided direct doesn emitted en ensure entire events function gain github greetings guide hello increase instant interpolateparams js key language level license licensed listen loading longer manner method methods migration mit moved note occurrences organization overview performance project promise rename repositories service simply stringfromservice structural style supported sync synchronous tables terms translate translation translationid translations unable update updated var version wait wtfpl"
    },
    {
      "section": "guide",
